...
public class ArtistNewReleaseModule extends ViewObject {
    ...
    public Matcher<View> matcher() {
        return allOf( withId( R.id.item_list_root_layout ),
                      hasDescendant( anyOf(
                              withText( ArtistNewReleaseModule.titleInEnglish ),
                              withText( ArtistNewReleaseModule.titleInJapanese ) ) ) ) ;
    }
    ...
    public class InternalLineUp extends LineUpObject {
        ...
        protected String getTitleOfLineUpInEnglish() {
            return ArtistNewReleaseModule.titleInEnglish ;
        }

        protected String getTitleOfLineUpInJapanese() {
            return ArtistNewReleaseModule.titleInJapanese ;
        }
