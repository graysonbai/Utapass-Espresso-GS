...
public class WhatsNewModule extends ViewObject {
    ...
    public Matcher<View> matcher() {
        return allOf( withId( R.id.item_list_root_layout ),
                      hasDescendant( anyOf(
                              withText( WhatsNewModule.titleInEnglish ),
                              withText( WhatsNewModule.titleInJapanese ) ) ) ) ;
    }

    public LazyString title() {
        return new LazyString( WhatsNewModule.label + " > Title",
                () -> allOf(
    ...
    public BasicButton seeAll() {
        return new BasicButton( WhatsNewModule.label + " > See All Button",
                () -> allOf(
    ...
    public class InternalLineUp extends LineUpObject {
        ...
        public InternalLineUp() {
            this.addLabel( WhatsNewModule.label ) ;
        }

        protected String getTitleOfLineUpInEnglish() {
            return WhatsNewModule.titleInEnglish ;
        }

        protected String getTitleOfLineUpInJapanese() {
            return WhatsNewModule.titleInJapanese ;
        }
