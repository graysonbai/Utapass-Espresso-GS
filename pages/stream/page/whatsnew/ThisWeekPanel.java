package com.kddi.android.UtaPass.sqa_espresso.pages.stream.page.whatsnew;
...
public class ThisWeekPanel extends BasicPage {
    private InternalLineUp lineup ;

    public ThisWeekPanel(){
        this.label( "ThisWeekPanel" );
    }
    ...
    public class InternalLineUp extends LineUpObject {
        ...
        protected Matcher<View> getMatcherToFindRecycleView() {
            return withId( R.id.cards_recycler_view ) ;
        }
