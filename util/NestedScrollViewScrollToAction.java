...
public final class NestedScrollViewScrollToAction implements ViewAction {
    ...
    public void perform(UiController uiController, View view) {
        ...
        View parentViewPager = findViewPager(view);

        CoordinatorLayout.LayoutParams params = (CoordinatorLayout.LayoutParams) parentViewPager.getLayoutParams();
        params.setBehavior(null);
        parentViewPager.requestLayout();
